...
All Onagraceae genera described in \citet{wagner2007revised} were recovered as monophyletic clades with posterior probabilities $> 0.95$
...
with a proportional likelihood ($PL$) of $0.61$ (Figure \ref{petal_color}).
White was the second most likely estimate ($PL=0.11$).
The maximum likelihood estimate of petal number for the
last common ancestor of Onagraceae was 4 ($PL=1.0$), with 15
independent transitions to 0, 2, 5, or 6 petals (Figure \ref{petal_number}).
...
\begin{figure*}[p]
    ...
    White = 0, Blue = 2, Green = 4, Yellow = 5, Red = 6. Vertical time scale is in millions of years before present.
    }
    \label{petal_number}
\end{figure*}
